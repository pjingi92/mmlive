...
async function getEmbeddedKoreanFontCss() {
    ...
    try {
      ...
      return `
        @font-face {
          ...
          src: url(data:font/${candidate.format};base64,${base64Font}) format('${candidate.format}');
          font-weight: 400;
          font-style: normal;
        }
      `;
  ...
  console.warn(
    "[send-estimate] 한글 폰트 파일을 찾지 못했습니다. public/fonts/NotoSansKR-Regular.ttf 파일을 추가해주세요."
  );
